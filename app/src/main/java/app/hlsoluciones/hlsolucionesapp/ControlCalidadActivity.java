...
public class ControlCalidadActivity extends AppCompatActivity {

    private int  id = 0, area_id = 0, servicio_id = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int nightModeFlags = ControlCalidadActivity.this.getResources().getConfiguration().uiMode & Configuration.UI_MODE_NIGHT_MASK;
    ...
    private void init(){
        ...
        btnAddControlCalidad = findViewById(R.id.btnAddControlcalidad);
        imgSeg1 = findViewById(R.id.imgSeg1Calidad);
        imgSeg2 = findViewById(R.id.imgSeg2Calidad);
        imgSeg3 = findViewById(R.id.imgSeg3Calidad);
        imgSeg4 = findViewById(R.id.imgSeg4Calidad);
        txtot = findViewById(R.id.txtOTSeleccionada);
        ...
        id = getIntent().getIntExtra("seguimiento_id", 0);
        ...
        txtFechaactual.setText("N°Placa del Vehiculo: "+getIntent().getStringExtra("numero_placa"));


        btnAddControlCalidad.setOnClickListener(v->{
            AlertDialog.Builder builder = new AlertDialog.Builder(ControlCalidadActivity.this);
    ...
    private void guardarControlCalidad() {
        ...
        StringRequest request = new StringRequest(Request.Method.PUT, Constraint.UPDATE_SEGUIMIENTO+id,response -> {
        ...
        RequestQueue queue = Volley.newRequestQueue(ControlCalidadActivity.this);
        queue.add(request);
    }
