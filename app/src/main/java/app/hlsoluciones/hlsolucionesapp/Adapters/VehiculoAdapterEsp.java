...
public class VehiculoAdapterEsp extends RecyclerView.Adapter<VehiculoAdapterEsp.VehiculoHolder>{
    ...
    public VehiculoAdapterEsp(Context context, ArrayList<Vehiculo> list) {
...
//        this.sharedPreferences = context.getApplicationContext().getSharedPreferences("user", Context.MODE_PRIVATE);
    ...
    public void onBindViewHolder(@NonNull VehiculoHolder holder, int position) {
        ...
        if (vehiculo.getCifravin().equals("null")){
            ...
            holder.txtCifravin.setText(vehiculo.getCifravin());
        }
        ...
        holder.btnOptions.setOnClickListener(v->{
            ...
            popupMenu.inflate(R.menu.menu_vehiculo_options_esp);
                    ...
                    switch (menuItem.getItemId()){
                        case R.id.item_edit:{
                            if (sharedPreferences.getInt("id",0) != vehiculo.getUser().getId()){
                                ...
                                Intent i = new Intent(((HomeEspecializadoActivity)context), EditVehiculoActivity.class);
                        ...
                        case R.id.item_especializado:{
                            if (vehiculo.getStatus().equals("2") || vehiculo.getStatus().equals("4") || vehiculo.getStatus().equals("3")){
                                Toast.makeText(context, "Accion no disponible: Vehiculo con Servicio Finzalizado", Toast.LENGTH_SHORT).show();
                                return true;
                            }
                                ...
                                Intent i = new Intent(((HomeEspecializadoActivity)context), AddEspecializadoActivity.class);
                                i.putExtra("vehiculo_id", vehiculo.getId());
                                i.putExtra("num_placa", vehiculo.getNumplaca());
                                context.startActivity(i);
                                return true;
